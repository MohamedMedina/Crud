...
namespace Crud.Controllers
{
    public class Employees1Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployysID,Name,Position,Age,Salary")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployysID,Name,Position,Age,Salary")] Employee employee)
        {
            if (ModelState.IsValid)
            {
